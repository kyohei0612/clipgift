...
## 販売モデル（Phase 1 = 2026-06-01 ローンチ予定）

> **2026-05-21 更新**: ローンチ日 5/22 → 6/01 へ 10 日延期。Tauri 化（exiledesk と同スタック、ハイブリッド構成）を Phase 2 計画から Phase 1 に前倒し。詳細: `.company/secretary/notes/2026-05-21-decisions.md`
